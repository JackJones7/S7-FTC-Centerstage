...
public class TestS7RobotAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        */
        ...
        robot.lineToConstantHeading(new Vector2d(-35.81, -35.81));
        robot.lineToConstantHeading(new Vector2d(-59.51, -12.58));
        robot.splineTo(new Vector2d(-47.21, 6.53), Math.toRadians(0.00));
        robot.splineTo(new Vector2d(-34.91, -5.77), Math.toRadians(-90.00));
    }
}
